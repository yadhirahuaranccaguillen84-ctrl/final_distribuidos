...
--  ============================================================
--  SE ELIMINARON LAS LÍNEAS DE 'CREATE OR REPLACE PROCEDURAL LANGUAGE' 
--  Y 'ALTER PROCEDURAL LANGUAGE' QUE CAUSABAN EL ERROR 42501
--  ============================================================
...
-- Nota: Si el comando ALTER TABLE de abajo también te da error de permisos, 
-- puedes comentarlo poniéndole dos guiones '--' al inicio de la línea.
